...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div id="dashboard-shell" className="min-h-screen flex flex-col">
      <header id="dashboard-header" className="sticky top-0 z-20 border-b border-line bg-panel/90 backdrop-blur-xl">
      ...
      <main id="dashboard-main" className="flex-1 w-full flex flex-col min-h-0">{children}</main>
      <footer id="dashboard-footer" className="border-t border-line py-5">
